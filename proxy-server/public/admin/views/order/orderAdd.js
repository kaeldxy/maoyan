...
export default class {
    constructor(el) {
        ...
        this.template =
            `
        <div class="orderAdd-page">
            <form class="layui-form" action="" lay-filter="orderAdd" >
                ...
                <div>请选择一条排片</div>
                <table id="check-schedule" lay-filter="check-schedule"></table>
                <div class="seat-box">
                ...
                <div class="layui-form-item">
                    <div class="layui-input-block">
                        <button type="button" class="layui-btn" lay-submit lay-filter="orderAdd">添加</button>
                    </div>
                </div>
            </form>
        </div>
    ...
    handle() {
        ...
        let row = null;
        let col = null;
        layui.table.on('tool(check-schedule)', function (obj) {
            var data = obj.data;
        ...
        layui.form.on('submit(orderAdd)', function (data) {
            Object.assign(data.field, { row, col, scheduleId})
            delete data.field.layTableRadio_1;
            $.ajax({ // 添加
                url: '/api/order/add',
                type: 'post',
                data: data.field,
